...
/*Funkcja sprawdza pokolei warto�� planszy*/
...
/*Sprawdza rz�dy macierzy i zwraca true je�eli jeden z graczy wygra�*/
bool Plansza::wygrana(Gracz gracz)
{
	/*Liczniki u�ywane do por�wnania sytuacji na planszy z wymaganym rz�dem*/
	int pomocx = 0;
	int pomocy = 0;

	/*Sprawdza poziom oraz pion*/
	/*Pomocnik zmienia si� po sprawdzeniu poziomu i pionu*/
	...
	/*pomocnik w celu zachowania wzgl�dnie sta�ej warto�ci na i, taki punkt odniesienia j r�wnie�*/
...
{
	/*Wartosc s�u�y jako infinity do por�wnywania*/
	int wartosc = 1000;
	Ruch ruch;
...
/*Algorytm s�u�y do przeprowadzenia ruch�w, wy�wietla */
